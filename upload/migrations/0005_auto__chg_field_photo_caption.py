...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('upload_photo', 'caption', self.gf('django.db.models.fields.TextField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Photo.caption'
        db.alter_column('upload_photo', 'caption', self.gf('django.db.models.fields.CharField')(max_length=300))
