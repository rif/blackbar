...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlackbarProfile'
        db.create_table(u'upload_blackbarprofile', (
        ...
        db.send_create_signal(u'upload', ['BlackbarProfile'])


    def backwards(self, orm):
        # Deleting model 'BlackbarProfile'
        db.delete_table(u'upload_blackbarprofile')
