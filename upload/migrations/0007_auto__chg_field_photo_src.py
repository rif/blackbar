...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('upload_photo', 'src', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Photo.src'
        db.alter_column('upload_photo', 'src', self.gf('django.db.models.fields.files.FileField')(max_length=100))
